...
/****** Object:  Job [DBATools - Threadpool wait collector]    Script Date: 12/9/2021 3:02:26 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 12/9/2021 3:02:26 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'DBATools - Threadpool wait collector', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [run]    Script Date: 12/9/2021 3:02:27 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'run', 
		...
		@command=N'
	INSERT INTO DBATOOLS.DBO.Threadpoolwaits
	SELECT 
        dowt.session_id,
	...
	--	 into Dbatools.dbo.threadpoolwaits
