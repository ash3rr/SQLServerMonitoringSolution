...
/****** Object:  StoredProcedure [dbo].[sp_topwaitmonitor]    Script Date: 12/9/2021 4:22:14 AM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_topwaitmonitor] AS
...
insert into dbatools.dbo.top_waits
SELECT
