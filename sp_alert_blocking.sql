...
/****** Object:  StoredProcedure [dbo].[Alert_Blocking]    Script Date: 20.09.2022 12:21:12 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[Alert_Blocking]
    ...
    @BlockedSessionThreshold smallint = 5,
    @EmailRecipients varchar(max) = 'asher.rankin@bbraun.com',
